...
/***/ "./node_modules/@hokify/vuejs-datepicker/dist/vuejs-datepicker.esm.js":
/*!****************************************************************************!*\
  !*** ./node_modules/@hokify/vuejs-datepicker/dist/vuejs-datepicker.esm.js ***!
  \****************************************************************************/
...
var utils = {
  ...
  getDayNameAbbr: function getDayNameAbbr(date) {
    ...
    return moment__WEBPACK_IMPORTED_MODULE_0___default()().setDay(this.getDay(date)).locale(this.language).format('ddd');
  },
  ...
  getMonthName: function getMonthName(date) {
    if (typeof date === 'object') {
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).locale(this.language).format('MMMM');
    }

    if (typeof date === 'number') {
      return moment__WEBPACK_IMPORTED_MODULE_0___default()().month(date).locale(this.language).format('MMMM');
    }
  ...
  getMonthNameAbbr: function getMonthNameAbbr(date) {
    if (typeof date === 'object') {
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).locale(this.language).format('MMM');
    }

    if (typeof date === 'number') {
      return moment__WEBPACK_IMPORTED_MODULE_0___default()().month(date).locale(this.language).format('MMM');
    }
  ...
  getDaysOfWeek: function getDaysOfWeek(mondayFirst) {
    var date = moment__WEBPACK_IMPORTED_MODULE_0___default()().day(0);
  ...
  formatDate: function formatDate(date, format) {
    return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).locale(this.language).format(format);
  },
