...
Route::post('/admin/sporttypes/add', 'AdminController@storeSportType')->middleware('admin');
Route::delete('/admin/sporttypes/delete/{id}', 'AdminController@deleteSportType')->middleware('admin');
